...
$BIN_PATH query $DATABASE_NAME $INPUT_SEQUENCES -lowest species -threads $NUM_THREADS -abundance-per species -pairfiles -out $OUTPUT_FILE -maxcand 4 -hitmin 4 -hitdiff 80
