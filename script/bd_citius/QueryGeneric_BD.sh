...
PROCESSES_NUMBER=8
THREADS_NUMBER=2
DATABASE_NAME="/media/glusterfs/genomics/Databases/${DATASET}_${PROCESSES_NUMBER}/DB_${DATASET}.db"
OUTPUT_DIR="/media/glusterfs/genomics/Outputs/Output_${DATASET}_${INPUT_DATASET}_${PROCESSES_NUMBER}P_${THREADS_NUMBER}T.txt"
